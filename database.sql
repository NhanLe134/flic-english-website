...
-- Cleanup legacy redundant tables
...
ALTER TABLE [dbo].[NGUOIDUNG_QUYENHAN] ADD CONSTRAINT [FK_NDQH_NGUOIDUNG] FOREIGN KEY ([MaNguoiDung]) REFERENCES [dbo].[NGUOIDUNG] ([MaNguoiDung]);
ALTER TABLE [dbo].[NGUOIDUNG_QUYENHAN] ADD CONSTRAINT [FK_NDQH_QUYENHAN] FOREIGN KEY ([MaQuyenHan]) REFERENCES [dbo].[QUYENHAN] ([MaQuyenHan]);
ALTER TABLE [dbo].[KETQUABAIKIEMTRA] ADD CONSTRAINT [FK_KQBKT_BAIKIEMTRA] FOREIGN KEY ([MaBaiKiemTra]) REFERENCES [dbo].[BAIKIEMTRA] ([MaBaiKiemTra]);
ALTER TABLE [dbo].[KETQUABAIKIEMTRA] ADD CONSTRAINT [FK_KQBKT_SINHVIEN] FOREIGN KEY ([MaSinhVien]) REFERENCES [dbo].[SINHVIEN] ([MaSinhVien]);
GO
