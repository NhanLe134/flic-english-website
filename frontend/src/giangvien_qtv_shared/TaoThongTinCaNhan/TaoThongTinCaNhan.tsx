import "./TaoThongTinCaNhan.css";
import { useNavigate } from "react-router-dom";
import { useState, useRef } from "react";

const TaoThongTinCaNhan: React.FC = () => {
  ...
  return (
    <div className="page-container">
      ...
      <div className="topbar">
        <img src={`${import.meta.env.BASE_URL}image.png`} className="logo" alt="logo" />
...
export default TaoThongTinCaNhan;
