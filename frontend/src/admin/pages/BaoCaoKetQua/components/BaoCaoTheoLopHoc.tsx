...
interface BaoCaoTheoLopHocProps {
...
export default function BaoCaoTheoLopHoc({
  filtered,
  paginatedData,
  allLessons,
  activeHeaders,
      ...
      <div className="chartSection">
        <div className="chartCard">
          <h3 className="chartTitle">
            Phân phối Điểm trung bình - Lớp: {filterClass || '—'}
          </h3>
        ...
        <div className="infoCard">
          <div>
            <h3 className="infoTitle">Thông tin lớp học</h3>
            <div className="infoGrid">
              <div className="infoItem"><span className="infoLabel">Lớp học:</span><span className="infoValue">{filterClass || '—'}</span></div>
              <div className="infoItem"><span className="infoLabel">Khóa học:</span><span className="infoValue">{filtered[0]?.courseName || '—'}</span></div>
              <div className="infoItem"><span className="infoLabel">Giảng viên:</span><span className="infoValue">{loadingTeachers ? 'Đang tải...' : (teachers.length > 0 ? teachers.join(', ') : 'Chưa phân công')}</span></div>
            </div>
          </div>
