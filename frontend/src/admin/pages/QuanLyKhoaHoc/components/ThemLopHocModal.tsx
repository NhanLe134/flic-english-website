...
import type { Course, Teacher } from "../kieuDuLieu";
...
interface ThemLopHocModalProps {
  ...
  addClassErrors: { name: string; maLop: string; maxStudents: string };
  setAddClassErrors: React.Dispatch<React.SetStateAction<{ name: string; maLop: string; maxStudents: string }>>;
  teachersList: Teacher[];
  onClose: () => void;
  onSave: () => Promise<void>;
}

export default function ThemLopHocModal({
  show,
  expandedCourse,
  courses,
  courseDetailsMap,
        ...
        <div className="modal-scrollable-body max-h-70">
          <div className="form-field-group">
            ...
            <input
              ...
              onChange={e => {
                setNewClassForm((p: any) => ({ ...p, name: e.target.value }));
          ...
          <div className="form-field-group">
            ...
            <select
              ...
              onChange={e => {
                setNewClassForm((p: any) => ({ ...p, maLop: Number(e.target.value) }));
